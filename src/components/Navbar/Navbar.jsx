...
<<<<<<< Updated upstream:src/components/Navbar/Navbar.jsx
    <div className="bg-red-800 ">
      <nav className="shadow-lg bg-white dark:bg-p4 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="#" className="flex items-center">
=======
    <nav className=" bg-white shadow dark:bg-gray-800 sticky  top-0 w-[100vw]  z-10">
